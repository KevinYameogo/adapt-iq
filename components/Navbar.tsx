export default function Navbar() {
  return (
    <nav className="flex items-center justify-between p-4 bg-black border-b border-white/10 sticky top-0 z-[100]">
      ...
      <a href="#solutions" className="whitespace-nowrap hover:text-white transition-colors uppercase tracking-widest">
        Solutions
      </a>
      <a href="#contact" className="whitespace-nowrap hover:text-white transition-colors uppercase tracking-widest">
        Contact
      </a>
    </div>
